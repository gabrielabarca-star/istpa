          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            <div className="relative">
              ...
              <h2 className="text-3xl md:text-4xl font-black mb-8 leading-tight tracking-tighter" style={{ color: COLORS.primary }}>
                BIENESTAR <span style={{ color: COLORS.terracotta }}>EMPLEABILIDAD</span>
              </h2>

              {/* Contenedor de Texto Normativo */}
              <div className="relative">
                <div 
                ...
                <p className="text-lg md:text-xl text-slate-700 leading-relaxed font-medium text-justify">
                  Nos encargamos de conducir, planificar, articular y supervisar los servicios institucionales de bienestar estudiantil, 
                  incluyendo tutoría, servicio psicopedagógico, asistencia social, empleabilidad, y tópico, 
                  asegurando su funcionamiento integral, oportuno y coherente con las Condiciones Básicas de Calidad, 
                  y garantizando la permanencia, retención y egreso oportuno de los estudiantes del Instituto, 
                  conforme al marco normativo vigente de la educación superior tecnológica.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative w-full aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Servicios de Bienestar Estudiantil"
                  fill
