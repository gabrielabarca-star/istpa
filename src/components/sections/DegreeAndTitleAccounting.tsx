...
const certifications = [
  {
    ...
    name: 'BDiploma de Egresado de Contabilidad',
    imageUrl: '/img/diploma_contabilidad1.png',
    icon: Award,
  },
  {
    type: 'Título Profesional',
    name: 'Profesional Técnico en Contabilidad',
    imageUrl: '/img/titulo_contabilidad.png',
    icon: GraduationCap,
  },
];

export default function DegreeAndTitleAccounting() {
          ...
          {certifications.map((cert, index) => {
            ...
            return (
              <div key={index} className="flex flex-col">
                ...
                >
                  {/* Indicador de estado activo lateral */}
                  <div 
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="bg-white p-4 md:p-10 rounded-[3rem] shadow-2xl shadow-slate-200 border border-slate-100 relative group">
            ...
            <div className="absolute top-12 right-12 opacity-5 group-hover:opacity-10 transition-opacity">
              <CheckCircle size={150} style={{ color: COLORS.gold }} />
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="text-center sm:text-left">
                <p className="text-[#1B355C] font-black text-sm uppercase tracking-wider">Certificación con Valor Oficial</p>
                <p className="text-slate-400 text-xs uppercase tracking-widest font-bold">Registrado ante el Ministerio de Educación</p>
              </div>
              <div 
