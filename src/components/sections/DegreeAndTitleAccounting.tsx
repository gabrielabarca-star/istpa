// components/DegreeAndTitleAccounting.tsx
...
const certifications = [
  { type: 'Grado', name: 'Bachiller Técnico en Contabilidad', imageUrl: '/img/grado-contabilidad.png', },
  { type: 'Título', name: 'Profesional Técnico en Contabilidad', imageUrl: '/img/titulo-contabilidad.png', },
];
