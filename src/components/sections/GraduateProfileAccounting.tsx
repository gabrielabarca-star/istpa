// components/GraduateProfileAccounting.tsx
...
const profilePoints: ProfilePoint[] = [
  { text: 'Al culminar, serás un profesional analítico, capaz de registrar, procesar y gestionar la contabilidad integral de cualquier organización.', borderColor: '#EF4444', },
  { text: 'Dominarás la liquidación de impuestos, la elaboración de planillas (PLAME) y la gestión de costos, asegurando el cumplimiento de las normativas vigentes.', borderColor: '#08D3C4', },
  { text: 'Tu perfil te permitirá asistir en auditorías, analizar estados financieros y ser un asesor clave para la toma de decisiones gerenciales y financieras.', borderColor: '#FBBF24', },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative w-full max-w-sm mx-auto h-[480px]">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[98%] h-[100%]">
              <Image src="/img/perfil_egresado_contabilidad.png" alt="Egresado de la carrera de Contabilidad" layout="fill" objectFit="cover" className="rounded-3xl"/>
            </div>
          </div>
          <div>
