...
const leftServices: Service[] = [
  { text: 'Préstamo de material bibliográfico a solicitud del usuario' },
  { text: 'Préstamos a domicilio' },
  { text: 'Préstamo en el área de trabajo' },
];

const rightServices: Service[] = [
  { text: 'Préstamo a sala de clases a los usuarios de los diferentes turnos' },
  { text: 'Servicio de Hemeroteca' },
  { text: 'Referencia y consulta (búsqueda de información audiovisual' },
];
