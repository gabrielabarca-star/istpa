...
// --- Iconos SVG (Mismos íconos que en Tópico) ---
...
const audienceData: AudienceItem[] = [
  ...
  { label: "Egresados y público autorizado", icon: PublicIcon },
];
