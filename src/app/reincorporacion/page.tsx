...
import ReincorporationSection from "@/components/sections/ReincorporationSection";
...
export default function ReincorporacionPage() {
  return (
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[500px] w-full overflow-hidden group">
          <Image
            ...
            alt="Reincorporación Estudiantil - ISTPA"
            fill
