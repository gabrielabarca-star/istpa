...
import StudentsStatsSection from "@/components/sections/StudentsStatsSection";
...
export default function IndicadoresAcademicosPage() {
  return (
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[500px] w-full overflow-hidden group">
          <Image
            ...
            alt="Indicadores Académicos - ISTPA"
            fill
