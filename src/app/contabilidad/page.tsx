  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex-1">
        {/* Banner Hero con Filtro Cinematográfico */}
        <section className="relative h-[500px] w-full overflow-hidden group">
          <Image
            src="/img/banner_contabilidad.png"
            alt="Carrera de Contabilidad - ISTPA"
            fill
            className="object-cover object-[center_10%] transition-transform duration-[20s] ease-linear group-hover:scale-110"
            priority
          />
