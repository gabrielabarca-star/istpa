...
import TitulacionModalitiesSection from "@/components/sections/TitulacionModalitiesSection";
...
export default function ModalidadTitulacionPage() {
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[500px] w-full overflow-hidden group">
          <Image
            src="/img/cabeceras/entrega-titulo.png"
            alt="Modalidad de Titulación - ISTPA"
            fill
