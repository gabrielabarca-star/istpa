...
import ScholarshipRequirementsSection from "@/components/sections/ScholarshipRequirementsSection";
    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[500px] w-full overflow-hidden group">
          <Image
            src="/img/cabeceras/becas.png"
            alt="Programa de Becas - ISTPA"
            fill
        ...
        <ScholarshipRequirementsSection/>
