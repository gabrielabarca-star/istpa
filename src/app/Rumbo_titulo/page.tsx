...
import GraduateRequirementsSection from "@/components/sections/GraduateRequirementsSection";
import  ProfessionalTitleRequirementsSection2013 from "@/components/sections/ProfessionalTitleRequirementsSection2013";
import ProfessionalTitleRequirementsSection from "@/components/sections/ProfessionalTitleRequirementsSection";
import DegreeModalitiesButtonSection from "@/components/sections/DegreeModalitiesButtonSection";
...
export default function RumboAlTituloPage() {
  return (
    <div className="flex min-h-screen flex-col bg-white">
      <Header />
      
      <main className="flex-1">
        {/* Banner Hero con Estilo Institucional y Filtro Premium */}
        <section className="relative h-[500px] w-full overflow-hidden group">
          <Image
            src="/img/cabeceras/modalidad-titulacion.png"
            alt="Rumbo al Título Profesional - ISTPA"
            fill
          ...
          <div className="container relative mx-auto flex h-full items-center px-6 z-20">
            <div className="max-w-4xl animate-in fade-in slide-in-from-left-10 duration-1000">
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white leading-[0.9] uppercase tracking-tighter drop-shadow-2xl">
                Rumbo al <br />
                <span style={{ 
                  color: COLORS.gold,
                  textShadow: '3px 3px 0px rgba(0,0,0,0.15)'
                }}>Título Profesional</span>
              </h1>
        ...
        <GraduateRequirementsSection />
        <ProfessionalTitleRequirementsSection2013 />
        <ProfessionalTitleRequirementsSection />
        <DegreeModalitiesButtonSection/>
